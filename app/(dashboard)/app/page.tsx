...
export default function DashboardOverviewPage() {
  ...
  const totalPortfolioValue = 3945100
  const monthlyChange = 244000
  const monthlyChangePercent = 6.6
  const ytdReturn = 14.6
          ...
          <CardContent className="p-6">
            <div className="grid lg:grid-cols-4 gap-6">
              ...
              <div className="p-4 rounded-xl bg-zinc-800/50 border border-zinc-700/50">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-bold text-zinc-100">{formatCurrency(3402000)}</span>
                </div>
                <p className="text-xs text-zinc-500 mt-1">
                  <span className="text-emerald-400">+$77K</span> from last month
                </p>
              </div>
            </div>
